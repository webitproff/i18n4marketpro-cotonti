...
**Важно**: некоторые файлы из списка (`i18n4marketpro.resources.php`, `i18n4marketpro.global.php`, `i18n4marketpro.input.php` и др.) не были включены в предоставленный код, поэтому их функциональность можно понять только по косвенным признакам (вызовы в других файлах). В данном руководстве мы рассматриваем только код, который доступен.
